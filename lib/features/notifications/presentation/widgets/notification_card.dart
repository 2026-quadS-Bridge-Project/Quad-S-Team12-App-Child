...
/// Notification card mirroring the parent app's `NotificationCard`.
/// Custom drag-to-swipe-delete (not `Dismissible`) to match parent UX 1:1.
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        // shade that both apps previously hard-coded.
