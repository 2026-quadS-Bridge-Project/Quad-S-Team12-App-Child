...
class NotificationsMock {
  ...
  /// `createdAt` values are anchored to a fixed clock so the rendered
  /// "15분 전" labels in mock states stay deterministic. Assumes the reader
  /// inspects this surface near 2026-05-25 14:45 local time, which yields a
  /// 15-minute delta against 14:30 on the same day.
  static final List<NotificationItem> filled = <NotificationItem>[
    NotificationItem(
      id: 'weekly-report',
